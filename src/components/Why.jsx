...
const Why = () => {
  ...
  <div className='w-full flex flex-col items-center justify-center h-[38px]'>
    <h1 className='w-full h-full text-center  font-bold text-xl text-[#231F20] leading-6 '>Why Choose Our Course?</h1>
  </div>
  <div className='w-full  min-h-[72px] flex justify-center items-center'>
    <p className='text-center font-light text-base leading-6'>Discover the key benefits of mastering Backend Engineering with the JAVA Spring Framework.</p>
  </div>
  </div>
  ...
  <div className='w-full mt-[20px] flex-col items-center justify-start gap-[12px] min-h-[1164px]  '>
    ...
    <Cards1/><Cards1/><Cards1/><Cards1/><Cards1/><Cards1/>
  </div>
